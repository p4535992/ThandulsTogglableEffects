...
// import './module/jquery-ui/external/jquery/jquery.js'
// import './module/jquery-ui/jquery-ui.min.js';
...
import { createTogglablesTable } from './module/htmlBuilder';
import { initLangEffect } from './module/helperLang';
...
Hooks.once('ready', async function () {
	...
	//	ui.notifications.warn(`The '${MODULE_NAME}' requires DAE to be installed and at least version 0.2.43 or many automation effects won't work`);
	//}
